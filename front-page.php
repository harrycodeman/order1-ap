...
<!--Подключение формы с календарем "Data Picker"-->
...
<!--END Подключение формы с календарем "Data Picker"-->
...
<div class="triparticles-wrapper">
  ...
  <div id="triparticles">
    ...
    <div class="title">
      ...
      <a class="blue" href="/">Другие статьи</a>
    </div>
    ...
    <div id="content" class="homepage" role="main">
      ...
      <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
        ...
        <div class="links">
          <a class="left blue" href="/"><img src="<?php bloginfo('template_url'); ?>/images/plane.png">Путевки в Париж</a>
          <br>
          <a class="left blue" href="/">Похожие направления</a>
        </div>
